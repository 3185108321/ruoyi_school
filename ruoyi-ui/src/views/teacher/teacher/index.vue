<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="关联sys_user的用户ID" prop="userId">
        <el-input
          v-model="queryParams.userId"
          placeholder="请输入关联sys_user的用户ID"
          clearable
    ...
    <el-table v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="关联sys_user的用户ID" align="center" prop="userId" />
      <el-table-column label="所属学院" align="center" prop="department" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="关联sys_user的用户ID" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入关联sys_user的用户ID" />
        </el-form-item>
        <el-form-item label="所属学院" prop="department">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        userId: [
          { required: true, message: "关联sys_user的用户ID不能为空", trigger: "blur" }
        ],
      }
    }
  },
